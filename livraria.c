...
void consultarPreco(Livraria livros[], int contadorLivros){
    ...
    if(qtdelivros > 0){
        printf("Estes são os livros com o preço abaixo de R$%.2lf", pesquisa);
        printf("Pressione ENTER para continuar...\n");
        getchar();
        getchar();
    } else{
        printf("Não foram encontrados livros com o preço abaixo de R$%.2lf", pesquisa);
        printf("Pressione ENTER para continuar...\n");
        getchar();
        getchar();
    }
...
void consultarAutor(Livraria livros[], int contadorLivros){
    ...
    printf("O autor possui %d livros na livraria.\n", qtdelivros);
    printf("Pressione ENTER para continuar...\n");
    getchar();
    getchar();
}
